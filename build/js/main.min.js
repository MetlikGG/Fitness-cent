...
/* harmony import */ var _modules_slider_init_slider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/slider/init-slider */ "./js/modules/slider/init-slider.js");
/* harmony import */ var _modules_video_init_video__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/video/init-video */ "./js/modules/video/init-video.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_slider_init_slider__WEBPACK_IMPORTED_MODULE_3__["initTrainersSlider"])();
    Object(_modules_video_init_video__WEBPACK_IMPORTED_MODULE_4__["initVideo"])();
...
var Form = /*#__PURE__*/function () {
  ...
  _createClass(Form, [{
    ...
    value: function reset(form) {
      ...
      form.querySelectorAll('.free-training__message').forEach(function (item) {
        return item.remove();
      });
      setTimeout(function () {
...
var Message = /*#__PURE__*/function () {
  ...
  _createClass(Message, [{
    ...
    value: function _messageTemplate(message, state) {
      ...
      return "<span class=\"free-training__message ".concat(cssClass, "\">").concat(message, "</span>");
    }
  }, {
    key: "removeMessage",
    value: function removeMessage(parent) {
      var parentMessage = parent.querySelector('.free-training__message');
      if (parentMessage) {
        parentMessage.remove();
      }
    }
...
var trainersSwiper = document.querySelector('.staff__swiper');
var reviewSwiper = document.querySelector('.swiper-reviews');
var initTrainersSlider = function initTrainersSlider() {
  if (trainersSwiper) {
    (function () {
      return new Swiper('.staff__swiper', {
        // eslint-disable-line
...
var parseMediaURL = function parseMediaURL(media) {
  var regexp = /https:\/\/www\.youtube\.com\/watch\?v=([\w-]+)/i;
